...
then
	...
	ftp -o ./workdir/misc/${RELEASE}/${ARCH}/QEMU_EFI.fd \
		https://retrage.github.io/edk2-nightly/bin/RELEASEARM_QEMU_EFI.fd
fi

echo Unmounting root partition...

cp /mnt/usr/mdec/bootarm.efi ./workdir/misc/${RELEASE}/${ARCH}/
umount /mnt
...
cp ./workdir/misc/${RELEASE}/${ARCH}/bootarm.efi /mnt/EFI/BOOT/
